...
import ColorSoundCollection from "./components/home/ColorSoundCollection";
  ...
  return (
    <BrowserRouter>
      <div className="min-h-screen bg-[radial-gradient(1200px_700px_at_85%_-15%,rgba(56,189,248,0.2)_0%,transparent_55%),radial-gradient(900px_600px_at_15%_20%,rgba(16,185,129,0.12)_0%,transparent_60%),#040712] text-primary-content">
        ...
        <Routes>
          <Route path="/" element={<HomeLayout onViewExample={scrollToScience} />} />
...
function HomeLayout({ onViewExample }: { onViewExample: () => void }) {
  return (
    <main>
      <HeroSection onViewExample={onViewExample} />
      <ScienceSection />
      <ExampleSection />
    </main>
  );
