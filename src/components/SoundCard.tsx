...
export default function SoundCard({sound}:{sound:SoundColor}){
  ...
  return (
    <Card>
      <div className="w-full h-36 bg-gradient-to-br from-black/10 to-black/5 flex items-end" aria-hidden>
        <div className="w-full h-full bg-cover bg-center" style={{backgroundImage: 'linear-gradient(180deg, rgba(0,0,0,0.0), rgba(0,0,0,0.2))'}} />
      </div>

      <div className="p-6">
        <div className="flex items-start gap-4">
          <div className={`w-3 h-12 rounded ${accent} shrink-0`} aria-hidden />
