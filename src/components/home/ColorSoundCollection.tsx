    ...
    <section id="colors" className="px-4 py-16">
      <div className="mx-auto max-w-6xl space-y-4 text-center">
        ...
        <p className="font-body mx-auto max-w-3xl text-base leading-relaxed text-base-content/80">
          Each palette has a mood, a frequency profile, and a recommendation for how to use it in your day.
        </p>
      </div>
        ...
        {SOUNDS.map((sound) => (
          <article
            ...
            <div className="flex items-center justify-between gap-3">
              ...
              <span
                className="h-1.5 w-16 rounded-full bg-gradient-to-r from-[#38bdf8] via-[#6366f1] to-[#f472b6]"
                aria-hidden
              />
            </div>
